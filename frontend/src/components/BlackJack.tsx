...
const BlackJack = ({
	...
	}, [getGameTableObjectData, gameTableObjectId, bettingAmount, wallet]);
	...
	const readyGame = async () => {
		...
		tx.moveCall({
			...
			arguments: [
				tx.object(config.GAME_INFO_OBJECT_ID),
	...
	return (
		...
		>
			...
			>
				...
				{loading === false &&
				config.DEALER_ADDRESSES.includes(wallet.address!) ? (
					<Button
						variant="contained"
						color="secondary"
						sx={{ width: "120px", fontWeight: "800" }}
